            ...
            <div class="div-conteudo" id="tabela">
                ...
                <div class="container-fluid div-topo">
                    ...
                    <table class="table table-bordered table-sm">
                        <thead>
                            <tr>
                                <th scope="col" id="titulo" colspan="6" style="text-align: center;">REPARO</th>    
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php
                                    ...
                                    if (isset($_POST['opcao'])) {
                                        $opcoesSelecionadas = $_POST['opcao'];
                                    
                                        // Processar as opções selecionadas
                                        foreach ($opcoesSelecionadas as $opcao) {
                                          // Faça o que precisar com cada valor selecionado
                                          echo "<td> $opcao</td>";
                                        }
                                    }
                                    echo "<td id='silver'>Valor do Orçamento:</td>";
                                    echo "<td> R$$orcamento</td>";
                                    echo "</tr>";
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            <tr>
                                <td id="silver">Data Orçamento:</td>
